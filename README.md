...
5. Press **Insert Coordinate** – the formatted coordinate is inserted at the cursor and copied to your clipboard.
...
* Coordinates are inserted with a trailing newline; adjust formatting manually if needed.
